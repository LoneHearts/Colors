...
public class ShootManager : MonoBehaviour
{
    ...
    public bool Shoot(ColorType.ColorType.Type m_type)
    {
        ...
        {
            m_canShoot = false;
            if(m_type == ColorType.ColorType.Type.White || m_type == ColorType.ColorType.Type.Red || m_type == ColorType.ColorType.Type.Orange || m_type == ColorType.ColorType.Type.Tangerine || m_type == ColorType.ColorType.Type.Yellow || m_type == ColorType.ColorType.Type.Green || m_type == ColorType.ColorType.Type.Lime)
            {
